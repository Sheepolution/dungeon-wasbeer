...
export default class MonsterManager {
    ...
    public static async AddNewMonster(name:string, description:string, level:number, category:string, type:AttackType, health:number, attack:number, imageUrl:string, creatorId:string) {
        const monster = new Monster();
        ...
        await monster.POST(name, description, level, category, type, health, attack, imageUrl, creatorId);
    ...
    public static async EditMonster(originalName:string, name?:string, description?:string, level?:number, category?:string, type?:AttackType, health?:number, attack?:number, imageUrl?:string) {
        const monster = new Monster();
        ...
        await monster.EditMonster(name, description, level, category, type, health, attack, imageUrl);
